...
function addArtist(array,id,name,years,genre,nationality,bio){
  newArr = array
  newArr.push ({id,name,years,genre,nationality,bio})
  return(newArr)
  }

console.log(addArtist(artists,20,"Justin Marks","1999 - 2098","Web Design","American","hes a super cool guy from Missouri"))
...
/* uses a Durstenfeld shuffle algorithm */
